			...
			<div class="row">
				<div class="form-group col-md-6">
					<label for="area">Area</label> <input type="text"
						...
						placeholder="obrigatório; área">
				</div>

				<div class="form-group col-md-6">
					<label for="população">População</label> <input type="text"
						class="form-control" name="populacao" id="populacao" placeholder="População obrrogatório">
				</div>
			</div>
			<hr />
